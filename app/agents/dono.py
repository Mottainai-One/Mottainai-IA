...
from app.tools.postgres_tools import get_kpis, get_sales_summary, get_stock_alerts
...
"""
    ...
    return {
        **state,
        ...
        "sources": sources + [{"type": "sql", "ref": "mottainai.sales_transaction + alert + disposal", "score": None}],
