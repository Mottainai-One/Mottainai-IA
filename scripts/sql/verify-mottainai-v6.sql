-- Mottainai v6: verificação somente leitura do schema operacional.
-- Alinhado à PR #11 (Mottainai-One/Mottainai-Banco-Operacional,
-- commit 473aadba0495acfcaea7d544e4b458b40b962b3d).
-- Execute via psql após aplicar o schema em um banco local novo.
SELECT
    ...
    AND to_regclass('mottainai.promotion_item') IS NOT NULL
